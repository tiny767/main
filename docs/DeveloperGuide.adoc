...
View specific persons with emailID and display all the information in the person card.
...
|`* * *` |user with frequently changing contacts |delete a person |to remove irrelevant data from address book
