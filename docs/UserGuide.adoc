...
** `li` + kbd:[TAB] : Completes to command word to `list`.
...
[NOTE]
Entered text must be within one edit-distance of the desired command. +
...
correct the command word without affecting the argumets entered.
====
