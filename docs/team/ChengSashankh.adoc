...
IB provides *end-to-end support* for recruiters, from searching for candidates,to adding job postings and saving their resumes and interviews.
...
include::../DeveloperGuide.adoc[tag=jobposting6]
